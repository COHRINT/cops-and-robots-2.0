...
'''
****************************************************
File: D4QuestBilliardSoftmaxModel.py
...
class ModelSpec:
	...
	def buildTransition(self):
		...
		r = self.yamlFile['info']['rooms']['billiard room']; 
	...
	def buildObs(self,gen=True):
		...
		if(gen):
			...
			self.pz.buildOrientedRecModel([checkers['centroid_x'],checkers['centroid_y']],checkers['orientation']+90,checkers['x_len'],checkers['y_len'],5); 
			...
			self.pz2.buildOrientedRecModel([cassini['centroid_x'],cassini['centroid_y']],cassini['orientation']+90,cassini['x_len'],cassini['y_len'],5); 

...
class ModelSpec:
	...
	def buildTransition(self):
		...
		#print(self.yamlFile); 
		r = self.yamlFile['info']['rooms']['hallway']; 
	...
	def buildObs(self,gen=True):
		...
		if(gen):
			...
			#NOTE: Shifted orientation by 90 degrees 
			vern = self.yamlFile['fern']; 
			self.pz.buildOrientedRecModel([vern['centroid_x'],vern['centroid_y']],vern['orientation']+90,vern['x_len'],vern['y_len'],5); 

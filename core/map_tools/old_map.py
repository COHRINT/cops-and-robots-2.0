...
""" USED TO BE CALLED map.py LT changed the name for linking purposes """
...
from core.map_tools.map_elements import MapObject, MapArea
from core.map_tools.shape_layer import ShapeLayer
from core.map_tools.feasible_layer import FeasibleLayer
from core.map_tools.probability_layer import ProbabilityLayer
from core.map_tools.particle_layer import ParticleLayer

...
class SimpleGoalPlanner(GoalPlanner):
        ...
        #mapA pose list
        pose_list = [[0, -2.25,0],[-4,-1,0],[-3,2,0],[2,-2,0],[4,-1,0],[1,2,0],[2.5,2,0],[4.5,2,0],[-3,-2,0],[4.5,-2,0]]

        # mapC pose list
        #pose_list = [[-4,2,0],[-3.5,-1.5,0],[-1,0,0],[1,-0.5,0],[-1,2,0],[-1.5,-2,0],[2,2,0],[1.5,-2,0],[3.5,-1.5,0],[4,1.5,0]]; 
